...
export const Carousel: FC<IPageImg> = ({
  imagesArr,
  PAGE_WIDTH,
  pageAlt,
  resetIMG,
  ...
  useEffect(() => {
    ...
    setSlidePage(imagesArr.find((child: {}, i: number) => i === slideNumber));
  ...
  return (
    <div className="flex flex-col align-middle">
      <div
        className={`flex flex-row  items-center h-[100%] `}
        style={{ maxWidth: `${widthDiv}` }}
      >
        ...
        <div
          className={`flex flex-row items-center relative h-[100%] overflow-hidden w-auto`}
        >
            ...
            imagesArr.map((item, indexDot) => {
              return (
                <button
                  ...
                  style={{
                    backgroundColor:
                      indexDot === slideNumber ? "#AE4A84" : "rgb(168 162 158)",
                  }}
                ></button>
              );
            })}
