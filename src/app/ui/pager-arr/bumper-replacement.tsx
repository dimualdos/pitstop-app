...
export const bumperReplacement = {
    ...
    liFirstDiv: ['когда на бампере имеются обширные трещины;',
    ...
    {
        auto: 'Subaru',
        repairArray: [bamperReplacementSubaru, bamperReplacementSubaru1, bamperReplacementSubaru2, bamperReplacementSubaru3, bamperReplacementSubaru4],
    },
    {
        auto: 'Hyundai',
