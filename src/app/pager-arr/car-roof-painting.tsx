import hoodPaintMits1 from '/public/покраска-крыши/Mitsubishi/mits1.webp'
import hoodPaintMits from '/public/покраска-крыши/Mitsubishi/mits.webp'
import hoodPaintSSang1 from '/public/покраска-крыши/SsangYong/eng1.webp'
import hoodPaintSSang2 from '/public/покраска-крыши/SsangYong/eng2.webp'
import hoodPaintSSang3 from '/public/покраска-крыши/SsangYong/eng3.webp'
import hoodPaintSSang4 from '/public/покраска-крыши/SsangYong/eng4.webp'
import hoodPaintSSang5 from '/public/покраска-крыши/SsangYong/eng5.webp'
import hoodPaintSSang6 from '/public/покраска-крыши/SsangYong/eng6.webp'
import hoodPaintSSang7 from '/public/покраска-крыши/SsangYong/eng7.webp'
import hoodPaintSSang8 from '/public/покраска-крыши/SsangYong/eng8.webp'
import hoodPaintSSang9 from '/public/покраска-крыши/SsangYong/eng9.webp'
import hoodPaintSSang10 from '/public/покраска-крыши/SsangYong/eng10.webp'
import hoodPaintSSang11 from '/public/покраска-крыши/SsangYong/eng11.webp'
import hoodPaintSSang from '/public/покраска-крыши/SsangYong/eng.webp'
import hoodPaintVolkswagen1 from '/public/покраска-крыши/Tiguan/wv1.webp'
import hoodPaintVolkswagen2 from '/public/покраска-крыши/Tiguan/wv2.webp'
import hoodPaintVolkswagen3 from '/public/покраска-крыши/Tiguan/wv3.webp'
import hoodPaintVolkswagen4 from '/public/покраска-крыши/Tiguan/wv4.webp'
import hoodPaintVolkswagen5 from '/public/покраска-крыши/Tiguan/wv5.webp'
import hoodPaintVolkswagen6 from '/public/покраска-крыши/Tiguan/wv6.webp'
import hoodPaintVolkswagen7 from '/public/покраска-крыши/Tiguan/wv7.webp'
import hoodPaintVolkswagen8 from '/public/покраска-крыши/Tiguan/wv8.webp'
import hoodPaintVolkswagen from '/public/покраска-крыши/Tiguan/wv.webp'
...
export const roofPainting = {
    ...
    <p>Окрас крыши автомобиля стоит дороже покраски остальных деталей. Это связано в первую очередь с тем, что у крыши намного больше площадь по отношению к той же двери. Поэтому и объем работ по подготовке к окраске значительно возрастает. Необходимо заметить, что мастерство маляра тоже должно быть высокого уровня, так как детали большой площади красить труднее и при отсутствии опыта можно совершить ошибки во время покраски.</p>
	...
	imagesArray: [
		...
		},
		{
			...
			repairArray: [
				hoodPaintVolkswagen,
				hoodPaintVolkswagen1,
				hoodPaintVolkswagen2,
				hoodPaintVolkswagen3,
				hoodPaintVolkswagen4,
				hoodPaintVolkswagen5,
				hoodPaintVolkswagen6,
				hoodPaintVolkswagen7,
				hoodPaintVolkswagen8
			]
		},
		{
			auto: 'Toyota',
