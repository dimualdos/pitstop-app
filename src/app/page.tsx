				...
				>
					...
					<div className='z-10 w-full items-center justify-between'>
						<p className='select-none hyphens-auto text-left indent-4 text-[14px] sm:text-base dark:text-stone-300'>
							Хотите, чтобы ваш автомобиль выглядел как новый? Тогда вам точно стоит обратиться в Pitstop-Online. Мы предлагаем широкий
							спектр услуг по ремонту и уходу за автомобилями, включая покраску, полировку, удаление вмятин и многое другое.{' '}
						</p>
					</div>
					<Carousel
						imagesArr={arrCar}
					...
					<div className='z-10 w-full max-w-5xl items-center justify-between'>
						<p className='select-none hyphens-auto text-left indent-4 text-[14px] sm:text-base dark:text-stone-300'>
							У нас работают только опытные мастера, которые знают, как справиться с любой задачей. Мы используем только качественные
							материалы и современное оборудование, чтобы гарантировать отличный результат.
						</p>
						<p className='select-none hyphens-auto text-left indent-4 text-[14px] sm:text-base dark:text-stone-300'>
							Но это еще не все! Мы также предлагаем удобные условия для наших клиентов. Наш сервис расположен в удобном месте, а процесс
							работы максимально прозрачен - вы всегда будете знать, на каком этапе находится ваш автомобиль.
						</p>
						<p className='select-none hyphens-auto text-left indent-4 text-[14px] sm:text-base dark:text-stone-300'>
							Обращаясь в Pitstop-Online, вы можете быть уверены, что ваш автомобиль попадет в надежные руки. Мы ценим каждого клиента и
							стремимся предоставить лучший сервис. Не откладывайте заботу о своем автомобиле на потом, обратитесь к профессионалам уже
							сегодня!
						</p>
					</div>
				</main>
