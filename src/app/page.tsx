...
export default function Home() {
  ...
  return (
    ...
    <main className={`${inter.className} flex  flex-col items-center justify-between gap-4`}>
      <h1 role="heading" className='text-base md:text-[18px] dark:text-stone-300 tracking-wider uppercase text-center font-semibold'>
        Обновленный автомобиль ждет вас в Pitstop-Online!
      </h1>
      <div className="z-10  w-full items-center justify-between  ">
        <p className=' text-[14px] sm:text-base text-left select-none hyphens-auto dark:text-stone-300 indent-4' >
